...
public class LicenciaTest {
    ...
    LicenciaDTO licenciaDTO2 = new LicenciaDTO(tit3, "No tiene nada", "A");
    ...
    void pruebaLicenciaRepetidaValida() {
        Assertions.assertFalse(licenciaService.repetida(licenciaDTO2)); //EN la base de datos este ususario no tiene una licencia de esta clase
    }
    @Test
